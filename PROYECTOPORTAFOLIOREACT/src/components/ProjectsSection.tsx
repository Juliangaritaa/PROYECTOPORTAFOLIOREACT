    ...
    <>
      <div className="mb-4">
        ...
        <div className="relative">
          ...
          {images.length > 1 && (
            <>
              <button onClick={prevImage} className="absolute left-2 top-1/2 -translate-y-1/2 bg-black/50 hover:bg-black/70 text-white p-1 rounded-full transition-colors">
                <ChevronLeft className="w-4 h-4" />
              </button>
              <button onClick={nextImage} className="absolute right-2 top-1/2 -translate-y-1/2 bg-black/50 hover:bg-black/70 text-white p-1 rounded-full transition-colors">
      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        >
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            These are some of my main projects. I'm constantly working on new challenges and improving my skills.
          </p>
          <a
